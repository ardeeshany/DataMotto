...
```{r, echo=F}
# knitr::knit_hooks$set(dotto = function(before, options, envir){
# if(before){
# paste(
# "<li class='nav-item'>",
# "<a class='nav-link active dm-dot-title'>, Introoo ,</a>",
# "<div class='dm-dot-content active'>", sep = "\n")
# } else {
# paste(
# "</div>",
# "</li>", sep = "\n")
...
# htmltools::HTML("
# <li class='nav-item'>
# <a class='nav-link active dm-dot-title'>Introooo</a>
