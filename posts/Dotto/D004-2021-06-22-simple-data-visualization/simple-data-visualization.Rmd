...
# Group variable will produce lines with different colors
ggplot(data=auto, aes(x=wheel.base, y=engine.size)) + geom_line(aes(group=fuel.type, color=fuel.type))
...
# Draw a set of vertical bars with nested grouping by a two variables
ggplot(data=auto, aes(x=body.style, y=city.mpg)) + geom_col(aes(fill=fuel.type))
