...
you can also see https://www.datam#create data frame using data.frame():
df1 <- data.frame("SN"=1:2,"Age"=c(21,15),"Name"=c("John","Dora"))
View(df1) #Invoke a spreadsheet-style data viewer on a matrix-like R object.
dim(df1) #number of rentor.io/r-programming/data-frame/
