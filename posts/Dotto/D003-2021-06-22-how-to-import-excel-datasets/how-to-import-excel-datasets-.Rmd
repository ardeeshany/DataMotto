...
In some situations, we want to import some columns or a specific sheet of excel. Now we want to handle this when we import the excel file.
...
when our dataset is so big we can load a specific number of rows in our project.
