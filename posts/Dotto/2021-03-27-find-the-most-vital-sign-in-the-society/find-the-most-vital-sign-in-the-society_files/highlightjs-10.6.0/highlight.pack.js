...
},e.COMMENT("\\*",";"),e.C_BLOCK_COMMENT_MODE]})})());hljs.registerLanguage("css",(()=>{"use strict"
...
begin:"\\b("+e.join("|")+")\\b"}]};var s}})());hljs.registerLanguage("stan",(()=>{"use strict";return _=>({name:"Stan",
...
end:'"',relevance:0}]})})());hljs.registerLanguage("scss",(()=>{"use strict"
...
end:/(?=#)|$/,contains:[b,o,r]},{begin:/\b(print|exec)\(/}]}}})());hljs.registerLanguage("node-repl",(()=>{"use strict";return e=>({
...
}],a.contains=n.contains,n}})());hljs.registerLanguage("fortran",(()=>{"use strict";function e(...e){
return e.map((e=>{return(n=e)?"string"==typeof n?n:n.source:null;var n
...
relevance:0},a,c]}}})());hljs.registerLanguage("stata",(()=>{"use strict";return e=>({name:"Stata",
