...
x <- "apple"
x
class(x)#type of object x
x <- 10 #reassignment
class(x) #new type of object x
#chaning assignment in R
y <- z <- x
...
for more information,see[this](https://www.datamentor.io/r-programming/factor/)
```
<!-- Dot 3, lang: python ------------------------------------------------>
...
You can also see [this](https://www.datamentor.io/r-programming/list/)
```
<!-- Dot 5, lang: python ------------------------------------------------>
