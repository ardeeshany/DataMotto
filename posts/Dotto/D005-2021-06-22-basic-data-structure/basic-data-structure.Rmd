...
df1 <-rbind(df1,list(1,16,"Paul")) 
df1 <- cbind(df1,State=c("NY","FL")) #add a new column to data frame
df1
#delete column "state" of df1 :
df1$State <- NULL 
#delete rows using reassignments :
df1 <- df1[-1,]
...
pd.DataFrame.from_dict(dic1, orient='columns' , dtype=None, columns=None)
```
